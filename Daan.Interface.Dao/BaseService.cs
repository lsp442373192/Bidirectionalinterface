...
namespace Daan.Interface.Dao
{
    public class BaseService
    {
        ...
        /// <returns></returns>
        public DataSet selectViewDS(string statementName, object param)
        {
            return baseDao.SelectDS(statementName, param, baseDao.getNewMapper());
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public IList<T> ViewQueryList<T>(string statementName, object param)
        {
            var str = baseDao.GetSql(statementName, param);
            return baseDao.getNewMapper().QueryForList<T>(statementName, param);
        }
        #endregion
