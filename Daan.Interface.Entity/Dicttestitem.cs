...
namespace Daan.Interface.Entity
{
    ...
    public sealed class Dicttestitem : BaseDomain
	{
		...
		private decimal? _dicttestitemid; 
		...
		private decimal? _timecycle; 
		private string _report; 
		private string _tubegroup; 
		private decimal? _dicttesttypeid; 
		private decimal? _dictcontainerid; 
		private decimal? _dictspecimentypeid; 
		private decimal? _testmethodid; 
		...
		/// 试管类型
		/// </summary>		
		public decimal? Dictcontainerid
		{
		...
		/// 标本类型
		/// </summary>		
		public decimal? Dictspecimentypeid
		{
		...
		/// 标本保存时间（单位：天）
		/// </summary>		
		public decimal? Specimenstoretime
		{
		...
		/// </summary>		
		public decimal? Dictreporttemplateid
		{
